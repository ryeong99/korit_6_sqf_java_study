...
public class BookService {
    ...
    private void modify() {
        ...
        search();
        System.out.println("수정 할 도서 번호 입력");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            switch (i) {
                case 0:
                    System.out.println("도서명을 수정하시겠습니까? (Y or N)");
                ...
                case 1:
                    System.out.println("저자명을 수정하시겠습니까?");
                    selected = scanner.nextLine();
                    if (selected.equalsIgnoreCase("Y")) {
                        String author = validateValue("저자");
                ...
                case 2:
                    System.out.println("출판사명을 수정하시겠습니까?");
                    selected = scanner.nextLine();
                    if (selected.equalsIgnoreCase("Y")) {
                        String publisher = validateValue("출판사");
        ...
        String bookName = duplicateBookName();
        String author = validateValue("저자");
        String publishe = validateValue("출판사");

        book.setBookName(bookName);
        book.setAuthor(author);
        book.setPublisher(publishe);
    }
