...
public class ArrayService {
    ...
    public static void main(String[] args) {
        ArrayUtiles arrayUtiles = new ArrayUtiles();
        ...
        while (isRun) {
            ...
            switch (selectedMenu) {
                ...
                case "2" :
                    ...
                    findIndex = arrayUtiles.findNameByName(names, modifyName);
                    if (findIndex == -1) {
                ...
                case "3" :
                    ...
                    findIndex = arrayUtiles.findNameByName(names, removeName);
                    if (findIndex == -1) {
                        System.out.println("해당 이름은 존재하지 않는 이름입니다.");
                        break;
                    }
                ...
                case "4" :
                    ...
                    findIndex = arrayUtiles.findNameByName(names, findName);
                    if (findIndex == -1) {
                        System.out.println("해당 이름은 존재하지 않는 이름입니다.");
                        break;
                    }
